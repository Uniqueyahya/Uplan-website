  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white flex flex-col font-sans selection:bg-purple-500 selection:text-white">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-6 sm:space-y-8">
        {/* Banner Section */}
        <div className="p-6 sm:p-10 rounded-3xl bg-[#141414] border border-white/10 relative overflow-hidden shadow-2xl">
        ...
        <div className="space-y-8 text-gray-300 text-sm leading-relaxed font-normal">
          ...
          {/* Section 1 */}
          <section className="p-6 sm:p-8 rounded-2xl bg-[#141414] border border-white/10 space-y-3">
          ...
          {/* Section 22 */}
          <section className="p-6 sm:p-8 rounded-2xl bg-[#141414] border border-white/10 space-y-4">
            <h2 className="text-xl font-extrabold text-white flex items-center gap-2">
